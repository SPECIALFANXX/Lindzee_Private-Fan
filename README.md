...
<div id="membership" class="page">
    ...
    <form id="membershipForm">
        ...
        <select id="membershipType" required>
            ...
            <option value="regular">$25 Regular</option>
        </select><br>
...
<div id="confirmation" class="page">
    ...
    <form id="confirmationForm">
        ...
        <p>By checking this box, you acknowledge and agree to the annual subscription fee of $25.</p>
        <label>
...
<div id="payment" class="page">
    ...
    <form id="paymentForm">
        <label>
            <input type="radio" name="paymentMethod" value="Crypto" required> Gift Card
        </label><br>
...
<div id="paymentConfirmation" class="page">
    ...
    <p>Please forward all payment screenshots to the following email address: anitadebby781@gmail.com</p>
...
<script>
    ...
    paymentForm.addEventListener('submit', function(event) {
        ...
        switch (selectedPaymentMethod) {
            case 'Crypto':
                paymentInfo = 'Crypto: Apple,Steam,Razer';
                break;
        }
